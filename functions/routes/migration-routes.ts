...
class MigrationRoutes {
  ...
  constructor() {
    ...
    this.migrationRoutes.post(`/${RoutesConstants.QUESTION}/${RoutesConstants.UPDATE_DASH_QUESTION_DASH_STATS}`,
      AuthMiddleware.authTokenOnly, MigrationController.updateQuestionStats);
