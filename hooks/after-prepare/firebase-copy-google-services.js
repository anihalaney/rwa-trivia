...
return new Promise(function(resolve, reject) {
        ...
        if (hookArgs.platform.toLowerCase() === 'android') {
            ...
            var sourceGoogleJsonProd = path.join($projectData.appResourcesDirectoryPath, "Android", `google-services/${hookArgs.platformSpecificData.env.project}/google-services.json.prod`);
            var sourceGoogleJsonDev = path.join($projectData.appResourcesDirectoryPath, "Android", `google-services/${hookArgs.platformSpecificData.env.project}/google-services.json.dev`);
