...
describe('TopicReducer: topTopics', () => {
    ...
    it('Verify topTopics function when action type is `LOAD_TOP_TOPICS_SUCCESS`', () => {
        ...
        const newState: Topic[] = _testReducer(topics, { type: TopicActions.LOAD_TOP_TOPICS_SUCCESS, payload: topics });
